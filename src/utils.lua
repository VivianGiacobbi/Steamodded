...
function SMODS.get_probability_vars(trigger_obj, base_numerator, base_denominator)
    ...
    local additive = SMODS.calculate_context({mod_probability = true, trigger_obj = trigger_obj, numerator = base_numerator, denominator = base_denominator})
    ...
    local fixed = SMODS.calculate_context({fix_probability = true, trigger_obj = trigger_obj, numerator = additive.numerator or base_numerator, denominator = additive.denominator or base_denominator})
