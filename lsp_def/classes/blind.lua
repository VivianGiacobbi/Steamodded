...
---@field save? fun(self: SMODS.Blind|table, saveTable: table) Handles saving custom Blind values. Values must be added to the provided saveTable, not returned
---@field load? fun(self: SMODS.Blind|table, blindTable: table) Handles loading custom Blind values from the provided blindTable
---@field post_load? fun(self: SMODS.Blind|table) Handler for Blind behavior on run reload, after the game state has been reset
---@field card_added? fun(self: SMODS.Blind|table, card: Card|table) Handles custom behavior in response to cards newly added to the deck/slots
